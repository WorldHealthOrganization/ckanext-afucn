            ...
            : ("Orthographic" !== m.projection
              ...
              a.events.on("zoomlevelchanged", function (e) {
                var a,
                  ...
                  n = c.bool(m.liveFilter.enabled),
                  l = c.maps[u].isDrilling,
                  s = c.maps[u].drilledTo,
                  d = c.filteredMap,
                  p = !1;
                r &&
                  ...
                  (p = !0),
                  n && c.bool(m.liveFilter.keepBase) && (p = !0),
                  o &&
                    Object.keys(o).length &&
                    Object.keys(o).forEach(function (t) {
                      r || n
                        ? (n && parseInt(d) === parseInt(o[t].overlay)) ||
                          (n && parseInt(d) === parseInt(u)) ||
                          (n && p && !c.bool(o[t].overlay)) ||
                          (l && s && parseInt(s) === parseInt(o[t].overlay)) ||
                          (r && !c.bool(o[t].overlay) && !p && !s) ||
                          (r && !c.bool(o[t].overlay) && p)
              ...
              : ((t.tooltip.label.interactionsEnabled = i.bool(r.fixed)),
                ...
                i.bool(r.fixed) &&
                  ("always" === r.showTooltipOn &&
                    ...
                    (t.tooltip.pointerOrientation = (function () {
